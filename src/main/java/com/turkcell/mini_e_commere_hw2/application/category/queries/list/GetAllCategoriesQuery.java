...
@NoArgsConstructor
public class GetAllCategoriesQuery implements Command<List<CategoryListingDto>> {

    @Component
    @RequiredArgsConstructor
    public static class Handler implements Command.Handler<GetAllCategoriesQuery, List<CategoryListingDto>> {
        private final CategoryRepository categoryRepository;

        @Override
        public List<CategoryListingDto> handle(GetAllCategoriesQuery query) {
